...
# Using car Anova for Wald chisquare test to see if estimates significantly differ from 0. Type 3 for ranef
...
imp.23$sequence <- as.character(imp.23$sequence)
...
# Using car Anova for Wald chisquare test to see if estimates significantly differ from 0. Type 3 due to presence of interactions and raneff
...
ggsave("plot.17.png", plot.17, width = 10, height = 6, dpi = 500)
